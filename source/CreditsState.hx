...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Tet',					'tet',				'Main Artist/Animator\n"Hasekui que hace kui kui"',											'https://twitter.com/ranfringW',		'C30085'],
			...
			['Fimbulveter',		'fim',					'Charter\n"How did I even get here?"',																'https://twitter.com/Fimbulveter2',			'4494E6'],
